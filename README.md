...
Best validation accuracy of **95.53%** achieved at epoch 18.
...
The model achieves **0.99 recall for caries**, meaning it correctly identifies 99% of all caries cases in the test set. This is the primary performance target for a clinically useful screening tool.
...
```bash
git clone https://github.com/YOUR_USERNAME/dental-caries-classifier
...
|---------|------|-------------|--------|
| [YOLOv8 Caries Segmentation](https://github.com/YOUR_USERNAME/yolov8-caries-detection) | Lesion detection + segmentation | YOLOv8n-seg | mAP50: 0.81 |
